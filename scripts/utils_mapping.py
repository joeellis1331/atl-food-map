...
# Create map with geocoded city center
    #atlanta GA city center coordinates
    cc_coordinates = (33.7490, -84.3880)
    #checks to ensure both latitude and longitude are found
    if cc_coordinates[0] is not None and cc_coordinates[1] is not None:
        #creates intial folium map
        folium_map = folium.Map(location=cc_coordinates, zoom_start=10, tiles=None)
